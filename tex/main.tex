...
\newcommand{\figref}[1]{\mbox{\textit{[\figurename ~\ref{fig:#1} on \pagename ~\pageref{fig:#1}]}}}
\newcommand{\tblref}[1]{\mbox{\textit{[\tablename ~\ref{tbl:#1} on \pagename ~\pageref{tbl:#1}]}}}
...
\subsection{Run: LZJD options and pre-processing}
