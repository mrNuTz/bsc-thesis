...
\begin{figure}[ht!]
  \centering
  \includegraphics[clip,trim={30 7 26 12},width=.33\linewidth]{../../ethereum-contract-similarity/runs/wallets/out/all violin raw lzjd.png}%
  \includegraphics[clip,trim={30 7 26 12},width=.33\linewidth]{../../ethereum-contract-similarity/runs/wallets/out/all violin fStat0 jump.png}%
  \includegraphics[clip,trim={30 7 26 12},width=.33\linewidth]{../../ethereum-contract-similarity/runs/wallets/out/all violin fstSecSkel bz.png}%
