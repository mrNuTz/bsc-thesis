...
\begin{figure*}[ht!]
  \centering
  \includegraphics[clip,trim={14 24 28 25},width=.33\textwidth]{../../ethereum-contract-similarity/runs/wallets/out/all hist raw lzjd.png}
  \includegraphics[clip,trim={14 24 28 25},width=.33\textwidth]{../../ethereum-contract-similarity/runs/wallets/out/all hist fStat0 jump.png}
  \includegraphics[clip,trim={14 24 28 25},width=.33\textwidth]{../../ethereum-contract-similarity/runs/wallets/out/all hist fstSecSkel bz.png}
