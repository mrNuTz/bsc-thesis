...
\subsection{jumpHash}
Inspired by ssdeep and the learnings from the solc-version-testet \cite{solc-versions-testset} I implemented jumpHash \cite{ethereum-contract-similarity}, it follows the steps:
\begin{ol}
