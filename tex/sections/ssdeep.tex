...
\subsection{BZ-Hash}
BZ-Hash is based on ImpHash \todo{cite ImpHash} that calculates the compression ratio for equal sized chunks of potentially malicious executables to generate a fingerprint.
