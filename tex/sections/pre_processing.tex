...
To define the \n{fStat} filter, we selected to top 30 opcodes by f-statistic value, plus a few that never occurred or only in one group. See \secref{sec:runOpcodes} for the f-statistic values and more details.
